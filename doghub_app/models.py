...
class UserProfile(models.Model):
    ...
    pic = models.ImageField(upload_to="user/",default="../static/images/profile1.jpg", null=True)
...
class DogProfile(models.Model):
    ...
    pic = models.ImageField(upload_to="dog/", default="../static/images/dog_profile.jpeg" ,null=True)
